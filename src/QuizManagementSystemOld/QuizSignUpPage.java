...
public class QuizSignUpPage extends JFrame{
    JPanel header;
    JPanel username;
    JPanel password;
    ...
    QuizSignUpPage() {
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("QuizManagementSystem\\images\\sign-up.png"));
        ...
        play.addActionListener(e -> {
            ...
            try {
                ...
                ps.executeUpdate();
                setVisible(false);
                new WhatQuizPage().setVisible(true);
            }
            catch (Exception e1){
        ...
        ImageIcon tab4 = new ImageIcon(ClassLoader.getSystemResource("QuizManagementSystem\\images\\sign-inbutton.png"));
        Image tab5 = tab4.getImage().getScaledInstance(496,65, Image.SCALE_DEFAULT);
        Icon tab6 = new ImageIcon(tab5);
        signInButton = new JButton(tab6);
        signInButton.setBounds(77,449,507,103);
