...
public class DeleteQuestionPage extends JFrame{
    ...
    DeleteQuestionPage() {
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("QuizManagementSystem\\images\\deleteheader.png"));
        ...
        ImageIcon img7 = new ImageIcon(ClassLoader.getSystemResource("QuizManagementSystem\\images\\deletebutton.png"));
        Image img8 = img7.getImage().getScaledInstance(250,33, Image.SCALE_DEFAULT);
        Icon img9 = new ImageIcon(img8);
        delete = new JButton(img9);
        delete.setBounds(60,571,250,33);
